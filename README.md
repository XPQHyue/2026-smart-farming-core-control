# 2026 Smart Farming Core Control

STM32F407VET6 智能小车底盘控制工程，面向 NUEDC 2026 相关赛题的固件与上位机工具集合。项目以 Keil uVision 5 工程为主体，配套 PID 参数整定脚本、发布说明和硬件资料，便于团队协作、版本交付和后续维护。
